        ...
        <div className=''>
            <div className='flex justify-between mb-[.5rem] absolute top-0 left-0 z-50 w-full'>
                ...
                <div className='mr-[1.5rem]'>
                    <button className='mt-[.1rem] border-red-600 border-2 text-red-600 font-semibold rounded-full ml-[1rem] mt-[1rem] h-10 w-24 hover:bg-red-600 text-white' onClick={handleLogin}>Login</button>
                    <button className='mt-[.1rem] border-red-600 border-2 text-red-600 font-semibold rounded-full ml-[1rem] mt-[1rem] h-10 w-24 hover:bg-red-600 text-white' onClick={handleRegist}>Register</button>
                </div>
            </div>
            {!searchQuery && 
